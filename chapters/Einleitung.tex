...
TI/TD\footnote{Das Team TI/TD ist für die Simulatorentwicklung innerhalb der DFS zuständig.} der \ac{DFS} gesammelt wurden. Dieses Projekt baut auf einer vorherigen Bachelorarbeit \cite{dominikDiez} auf, die Reinforcement Learning als Lösungsansatz für die teilautomatisierte Flugverkehrssteuerung in der Adjacent-Position untersucht hat.
...
Dieser soll es Lotsen ermöglichen, von Zuhause selbstständig zu üben. Speziell in diesem Szenario wäre eine KI-gestützte Lösung für die Adjacent-Position eine sinnvolle Erweiterung, da sie den Ausbildern die Arbeit abnehmen und den Trainees zusätzlich zu den im Vorhinein gebauten Szenarien mehr Übungsmöglichkeiten bieten könnte.
%
% Section: Ziele
%
...
\begin{itemize}
    ...
    \item \textbf{Algorithmische Machbarkeit:} Lässt sich der Proximal-Policy-Optimization-Algorithmus (PPO) durch die Integration von \emph{Gradient\hyp{}Gating} derart modifizieren, dass ein stabiles Lernverhalten trotz der bedingten Abhängigkeiten im gemischten Aktionsraum ohne Beeinträchtigung der Konvergenz gewährleistet ist?
...
Darauf aufbauend beschreibt Kapitel \ref{ch:ppo_bedingt} die notwendigen algorithmischen Anpassungen des PPO\hyp{}Algorithmus, um die Besonderheiten des zuvor definierten gemischten Aktionsraums effizient zu handhaben. Desweiteren wird auf daraus resultierende Probleme eingegangen und Lösungsmöglichkeiten vorgestellt.
