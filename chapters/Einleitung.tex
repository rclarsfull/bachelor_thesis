...
\begin{itemize}
    ...
    \item \textbf{Algorithmische Machbarkeit:} Lässt sich der Proximal-Policy-Optimization-Algorithmus (\ac{PPO}) durch die Integration von \emph{Gradient\hyp{}Masking} derart modifizieren, dass ein stabiles Lernverhalten trotz der bedingten Abhängigkeiten im gemischten Aktionsraum ohne Beeinträchtigung der Konvergenz gewährleistet ist?
...
Darauf aufbauend beschreibt Kapitel \ref{ch:ppo_bedingt} die notwendigen algorithmischen Anpassungen des \ac{PPO}\hyp{}Algorithmus, um die Besonderheiten des zuvor definierten gemischten Aktionsraums effizient zu handhaben. Desweiteren wird auf daraus resultierende Probleme eingegangen und Lösungsmöglichkeiten vorgestellt.
