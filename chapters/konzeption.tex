...
Die Arbeit von \citet{bluesky-gym} hat diese Arbeit maßgeblich beeinflusst, da sie eine open source Implementierung einer Bluesky\hyp{}\ac{GYM}\hyp{}Umgebung bereitgestellt haben, die als Grundlage für die Entwicklung des hier vorgestellten \ac{RL}\hyp{}Systems diente.
...
\section{Definition der \acs{RL}\hyp{}Umgebung}
...
Dies unterstützt den Lernprozess, da der Agent unmittelbares Feedback zur Qualität seiner Zustandsänderungen erhält \cite[Kap. 17.4]{sutton2018rl}, im Gegensatz zu \emph{Sparse Rewards}, die nur selten vergeben werden.
...
\section{Auswahl des \ac{RL}\hyp{}Algorithmus}
Für das Training des Agenten wurde Proximal Policy Optimization (\ac{PPO}) gewählt.
\ac{PPO} gehört zur Klasse der Policy\hyp{}Gradient\hyp{}Methoden (siehe Kapitel \ref{ch:rl_grundlagen}) und hat sich in zahlreichen Anwendungen als stabiler und robuster Standard etabliert \cite{OriginalPPO}.
\medskip
