...
$A_t$             & Advantage & Vorteil einer Aktion gegenüber dem Durchschnitt: $A_t = R_t - V_\phi(s_t)$. (Dies ist eine konzeptionelle Vereinfachung. \ac{SB3} implementiert in der Praxis die \textit{Generalized Advantage Estimation} (GAE) \cite{sb3}). \\
...
um ein \textit{Gradient\hyp{}Masking} zu realisieren. Dies stellt sicher, dass die Aktualisierung der Gewichte innerhalb eines verzweigten
