...
Die \textit{International Civil Aviation Organization} (ICAO) gibt hierfür Standards vor. Für den Streckenflug gelten in der Regel:
\begin{itemize}
...
Zur Lösung potenzieller Konflikte stehen drei grundlegende Manöver zur Verfügung, die den Flugpfad relativ zum \ac{CPA} verändern \cite{Che+23}:
\begin{enumerate}
...
Dies ist die Aufgabe der sogenannten \textit{Adjacent Position}.
