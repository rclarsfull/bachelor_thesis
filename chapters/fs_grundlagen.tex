...
Diese Arbeit fokussiert sich auf Szenarien im oberen Luftraum, in dem sich Flugzeuge zumeist entlang definierter Luftstraßen bewegen und im Vergleich zum An- und Abflugbereich eine geringere Komplexität aufweisen.
...
Dies umfasst zwei wesentliche Phasen: Zunächst müssen Flugzeuge sicher von ihrem Startpunkt (Spawn\hyp{}Punkt) zu dem im \ac{LoA} definierten Übergabepunkt am Rand des Trainingssektors navigiert werden.
Anschließend übernimmt der Agent die Flugzeuge wieder am Ausflugpunkt des Sektors und führt sie konfliktfrei zu einem Endpunkt (Despawn\hyp{}Punkt) außerhalb des Sichtbereichs des Lotsen.
...
Der zu entwickelnde Agent soll dieses professionelle Verhalten nachahmen: Er muss nicht nur lernen, wie Konflikte durch gezielte Kursänderungen vermieden werden können, sondern auch, wann keine Kurskorrektur erforderlich ist.
