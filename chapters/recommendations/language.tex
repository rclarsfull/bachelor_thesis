...
%
\begin{quote}
  \enquote{Carrier Sense Multiple Access (CMSA) bezeichnet im Bereich der Kommunikationssysteme eine Medienzugriffsverfahren mit dem mehrere voneinander unabhängige Sender einen gemeinsamen Kommunikationskanal nutzen könne. [...]. CSMA bildet eine wesentliche Grundlage für heutige Ethernet Netzwerke.}~\cite{wikipedia:csma}
\end{quote}
\smallskip
...
%
\begin{quote}
  \enquote{We used Lenovo ThinkPad R61 notebooks with 1.6 GHz, 2 GB RAM running Ubuntu Linux 7.10 with kernel version 2.6.22. We employed the internal Intel PRO/Wireless 4965 AG IEEE 802.11g WLAN adapters. The access point is a Buffalo Wireless-G 125 series running DD-WRT [...] version 24 RC-4.}
\end{quote}
