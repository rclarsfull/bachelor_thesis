...
In der Methode \texttt{evaluate\_actions()}, welche während der Optimierungsphase aufgerufen wird (siehe Algorithmus \ref{alg:ppo_training}, Zeile 20), werden die Komponenten der \ac{PPO}\hyp{}Verlustfunktion berechnet. Hier erfolgt das eigentliche Gradient\hyp{}Gating.
...
Algorithmus \ref{alg:gradient_gating} zeigt die Implementierung dieser Logik in vereinfachter, schematischer Form.

\begin{algorithm}
\caption{Gradient-Gating in der Evaluationsfunktion (vereinfacht)}
