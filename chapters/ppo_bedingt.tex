\chapter{Algorithmische Anpassungen von PPO}
...
Mathematisch wird die irrelevante kontinuierliche Aktion dadurch deterministisch und leistet keinen Beitrag zur Gesamt\hyp{}Log\hyp{}Likelihood. Dies verhindert effektiv, dass irrelevante Aktionen die Update\hyp{}Schritte des PPO verfälschen.
\vspace{\baselineskip}
...
Alternativ sind hybride Ansätze denkbar \cite{branching_architectures}, bei denen die Pfade zunächst gemeinsame Schichten durchlaufen, bevor die Aufspaltung erfolgt. Diese gemeinsamen Schichten, in der Literatur als \textit{Feature Extraction Layers} bezeichnet \cite{featureextraction}, dienen der Extraktion grundlegender Merkmale, die für beide Aufgaben relevant sind. Eine Visualisierung dieser Architektur findet sich in Abbildung \ref{fig:nn_architektur_hybrid}. 
