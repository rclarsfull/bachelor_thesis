...
In der Methode \texttt{evaluate\_actions()}, welche während der Optimierungsphase aufgerufen wird (siehe Algorithmus \ref{alg:ppo_training}, Zeile 20), werden die Komponenten der \ac{PPO}\hyp{}Verlustfunktion berechnet. Hier erfolgt das eigentliche Gradient\hyp{}Masking.
...
\subsection*{Erzwungene Exporation als Lösungsansatz}
