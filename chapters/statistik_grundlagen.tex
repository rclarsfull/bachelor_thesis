...
Die Bestimmung der Konfidenzintervalle erfolgt mittels Percentile-Bootstrap. \citet{statistical_rl_evaluation} untersuchen verschiedene Bootstrap-Varianten (Basic, Percentile, Bias-Corrected, BCa) und zeigen, dass im Kontext von Deep Reinforcement Learning mit wenigen Runs der Percentile-Bootstrap die zuverlässigste Abdeckung der wahren Werte liefert, während komplexere Methoden wie BCa bei kleinen Stichproben instabiler sein können. Das Vorgehen lässt sich wie folgt zusammenfassen:
\begin{enumerate}
...
Um dies zu erreichen, wird aus den Originaldaten beider Algorithmen in jeder Bootstrap-Iteration \(i\) jeweils eine Stichprobe mit Zurücklegen gezogen, für jede dieser Stichproben die Kennzahl (z.\,B. \ac{IQM}) berechnet und daraus die Differenz gebildet: \(\Delta_i = IQM_{A,i} - IQM_{B,i}\). Dies liefert eine empirische Verteilung der Differenzen. Das 95\%-Konfidenzintervall dieser Differenz-Verteilung ermöglicht eine präzise Aussage:
\begin{itemize}
