...
Statt einfacher Mittelwerte wird der Interquartile Mean (IQM) als robuste Lagekennzahl der episodischen Rewards genutzt. Der IQM mittelt nur über das mittlere 50\%-Quantil und dämpft damit Ausreißer deutlich \citep{statistical_rl_evaluation}.
...
\section{Vergleich zwei unterschiedlicher Varianten}
...
Um dies zu erreichen, wird aus den Originaldaten beider Algorithmen in jeder Bootstrap-Iteration \(i\) jeweils eine Stichprobe mit Zurücklegen gezogen, für jede dieser Stichproben die Kennzahl (z.\,B. IQM) berechnet und daraus die Differenz gebildet: \(\Delta_i = IQM_{A,i} - IQM_{B,i}\). Dies liefert eine empirische Verteilung der Differenzen. Das 95\%-Konfidenzintervall dieser Differenz-Verteilung ermöglicht eine präzise Aussage:
\begin{itemize}
