...
Statt einfacher Mittelwerte wird der Interquartile Mean (IQM) als robuste Lagekennzahl der episodischen Rewards genutzt. Der IQM mittelt nur über das mittlere 50\%-Quantil und dämpft damit Ausreißer deutlich \citep{statistical_rl_evaluation}. Für jede Variante wird der IQM der \emph{last\_eval\_mean}-Werte berechnet; das 95\%-Konfidenzintervall resultiert aus dem Percentile-Bootstrap mit \(B=5000\).
