...
Technically, this is realized by modifying the Proximal Policy Optimization (PPO) algorithm using ``Gradient\hyp{}Gating'' to stably learn the conditional dependencies in the action space.
