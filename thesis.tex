...
\usepackage{algorithm}      % Für \begin{algorithm} … \end{algorithm}
\usepackage{algpseudocode}  % Für \begin{algorithmic} … \end{algorithmic}
\usepackage{hyphenat}
...
\include{chapters/fs_grundlagen}
\include{chapters/rl_grundlagen}
\include{chapters/statistik_grundlagen}
\include{chapters/konzeption}
\include{chapters/ppo_bedingt}
